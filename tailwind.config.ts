  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-in-from-bottom": "slide-in-from-bottom 0.14s ease-out forwards",
        "slide-in-from-top": "slide-in-from-top 0.12s ease-out forwards",
        "zoom-in": "zoom-in 0.12s ease-out forwards",
