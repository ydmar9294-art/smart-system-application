...
const AuthFlow: React.FC<AuthFlowProps> = ({ onAuthComplete }) => {
  ...
  return (
    <>
      {showSplash && <LoginSplash onComplete={() => setShowSplash(false)} />}
      <div className={`min-h-screen flex flex-col font-tajawal relative bg-background transition-opacity duration-500 ${showSplash ? 'opacity-0' : 'opacity-100'}`} dir="rtl">
