...
const OwnerSubPageSheet: React.FC<Props> = ({ open, onClose, title, children }) => {
  ...
  return (
    <Drawer open={open} onOpenChange={(o) => !o && onClose()}>
      <DrawerPortal>
        <DrawerOverlay />
        <DrawerContent
          className="!h-[92vh] !mt-0 !rounded-t-[24px] border-t border-border bg-background flex flex-col"
        >
          <div
...
export default OwnerSubPageSheet;
