const en = {
  ...
  ownerCustomers: {
    ...
    creditCustomers: 'Customers with Credit',
    needsPayment: 'This customer needs to be paid',
  ...
  tracking: {
    ...
    noStopsToday: 'No stops today',
    hasWeekStops: 'You have other stops this week',
    upcomingStops: 'Upcoming Stops',
    routeHistory: 'Route History',
    filterByDistributor: 'Filter by distributor',
    noRouteHistory: 'No route history',
