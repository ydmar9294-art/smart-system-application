const ar = {
  ...
  guest: {
    ...
    feature1: 'إدارة كاملة للمبيعات والمخزون',
    feature2: 'تقارير وتحليلات مفصّلة',
    feature3: 'دعم فني متواصل على مدار الساعة',
  },
  ...
  reports: {
    ...
    thisMonth: 'هذا الشهر',
    custom: 'مخصص',
    financialHealth: 'مؤشرات الصحة المالية',
    collectionEfficiency: 'كفاءة التحصيل',
    healthGood: 'ممتاز',
    healthWarning: 'يحتاج تحسين',
    healthDanger: 'خطر - تحصيل ضعيف جداً',
    marginHealthy: 'هامش ربح صحي',
    marginAcceptable: 'هامش مقبول',
    marginLow: 'هامش منخفض - راجع التسعير',
    returnRate: 'نسبة المرتجعات',
    returnsNormal: 'ضمن المعدل الطبيعي',
    returnsHigh: 'مرتفعة - راجع جودة المنتجات',
    debtToSales: 'الديون/المبيعات',
    debtHealthy: 'نسبة ديون صحية',
    debtRisky: 'نسبة مرتفعة - خطر سيولة',
    salesTrend: 'اتجاه المبيعات (14 يوم)',
    revenueBreakdown: 'توزيع الإيرادات',
    fromTotal: 'من إجمالي',
    aiAdvice: 'نصائح الذكاء الاصطناعي',
    getAdvice: 'تحليل وتقديم نصائح',
    aiAdviceHint: 'اضغط الزر لتحليل بياناتك المالية والحصول على نصائح مخصصة',
  },
  ...
  invoice: {
    ...
    paidInUsd: 'دُفع بالدولار',
    receivedInUsd: 'قُبض بالدولار',
  ...
  ownerCustomers: {
    ...
    creditCustomers: 'زبائن لهم رصيد دائن',
    needsPayment: 'هذا الزبون يجب السداد له',
  ...
  tracking: {
    ...
    noStopsToday: 'لا توجد محطات اليوم',
    hasWeekStops: 'لديك محطات أخرى هذا الأسبوع',
    upcomingStops: 'المحطات القادمة',
    routeHistory: 'سجل المسارات',
    filterByDistributor: 'تصفية حسب الموزع',
    noRouteHistory: 'لا يوجد سجل مسارات',
