      ...
      <PullToRefresh onRefresh={handlePullRefresh}>
        ...
        >
          <main className="flex-1 relative">
            ...
            <div className="sticky top-0 z-50 flex justify-start items-center gap-2 pt-14 px-3 pb-1 pointer-events-none fixed-top-safe">
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 text-center" dir="auto">
      <div className="max-w-md space-y-6 animate-zoom-in">
        ...
        <h2 className="text-3xl font-black text-foreground">{isExpired ? t('license.expired') : t('license.suspendedTemp')}</h2>
        <p className="text-muted-foreground font-bold text-lg">{isExpired ? t('license.expiredDesc') : t('license.suspendedDesc')}</p>
